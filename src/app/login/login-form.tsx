...
export function LoginForm() {
  ...
  const [activeTab, setActiveTab] = useState<"credentials" | "wallet">(connectWallet ? "wallet" : "credentials")
  ...
  return (
    <Card className="w-full max-w-md mx-auto bg-gray-900 border-gray-800">
      <CardHeader className="space-y-1">
        <CardTitle className="text-2xl font-bold">Sign In to NexaWork</CardTitle>
        <CardDescription>Access your account using your preferred method</CardDescription>
      </CardHeader>
      <CardContent>
        <Tabs defaultValue={activeTab} onValueChange={(value) => setActiveTab(value as "credentials" | "wallet")}>
            ...
            {walletConnected ? (
                ...
                <div className="flex flex-col items-center justify-center py-8">
                  ...
                  <div className="w-full mt-6 p-4 border border-gray-700 rounded-lg">
                    <div className="flex justify-between items-center">
                      ...
                      <div className="text-base font-medium text-green-500">Connected</div>
                    </div>
                  </div>
                  <Button
                    className="w-full mt-8 bg-purple-600 hover:bg-purple-700 text-white h-14 text-lg"
              ...
              <div className="space-y-5">
                <p className="text-base text-muted-foreground text-center mb-4">
                  Connect your wallet to access your NexaWork account and manage your crypto payments
                </p>
                ...
                <div className="space-y-4">
                  <WalletOption
                    ...
                    connecting={walletConnecting && selectedWallet === "metamask"}
                  ...
                  <WalletOption
                    ...
                    connecting={walletConnecting && selectedWallet === "coinbase"}
                    disabled={walletConnecting}
                  />
                  <WalletOption
                    name="WalletConnect"
                    ...
                    connecting={walletConnecting && selectedWallet === "walletconnect"}
                    disabled={walletConnecting}
                  />
                  <WalletOption
                    name="Trust Wallet"
...
function WalletOption({ name, icon, onClick, connecting, disabled }: WalletOptionProps) {
  return (
    <Button
      variant="outline"
    ...
    >
      <div className="flex items-center">
        <img src={icon || "/placeholder.svg"} alt={name} className="w-7 h-7 mr-4" />
