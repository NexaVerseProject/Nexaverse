        ...
        <div className="flex flex-col md:flex-row gap-4 justify-between">
          ...
          <div className="flex gap-2">
            ...
            <Button variant="outline" className="gap-1">
              ...
              <span>Connected: 0x71C...8F3E</span>
            </Button>
          </div>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">≈ $2,350.45 USD</p>
                    ...
                    <Tabs defaultValue="eth" className="w-full">
                      ...
                      <TabsContent value="eth" className="space-y-4 mt-4">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-sm font-medium">1.245 ETH</span>
                        </div>
                      </TabsContent>
            ...
            <Card>
              ...
              <CardContent className="flex flex-col items-center">
                ...
                <p className="text-sm text-muted-foreground text-center">
                  Send only ETH, USDC, or other ERC-20 tokens to this address.
