...
import { DollarSign, FileText, Briefcase, BarChart3 } from "lucide-react";
...
const stats = [
  ...
  },
  {
    ...
    sub: "3 in the last month",
  },
];

const tabDefs = [
  { value: "active", label: "Active Jobs", color: "bg-nexapurple-700" },
  { value: "proposals", label: "Proposals", color: "bg-nexapurple-700" },
  { value: "completed", label: "Completed", color: "bg-nexapurple-700" },
];

const skills = [
  { name: "React", endorsements: 24, value: 80 },
  { name: "Solidity", endorsements: 18, value: 60 },
  { name: "Web3.js", endorsements: 15, value: 50 },
  { name: "TypeScript", endorsements: 21, value: 70 },
];
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-between">
            ...
            <div className="flex gap-3">
              ...
              <Link href="/marketplace">
                <Button className="bg-nexapurple-700 hover:bg-nexapurple-800 h-12 text-base">
                  Find Jobs
                </Button>
              </Link>
            </div>
                      ...
                      <div className="flex flex-col md:flex-row justify-between gap-4">
                        <div className="space-y-2">
                          <div className="flex items-center gap-2">
                            ...
                            <Badge className="bg-nexapurple-700">
                              In Progress
                            </Badge>
                          </div>
                    ...
                    <CardContent className="p-6">
                      <div className="flex flex-col md:flex-row justify-between gap-4">
                        <div className="space-y-2">
                          ...
                          <p className="text-muted-foreground">
                            Client: Digital Collectibles Inc.
                          </p>
                          <div className="flex gap-2">
